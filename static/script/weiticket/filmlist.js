...
$(document).ready(function() {
    ...
    $.get('/get/queryadvertisements/4', {type: 4, wxchannelCode: publicsignal}, function(adsHtml){
    ...
    function getCurrentPosition () {
        Util.repeat(Util.getCurrentPosition, 3).then(function (coords) {
            ...
            $.get('/queryLocation/' + coords.longitude + '/' + coords.latitude, function(renderData){
